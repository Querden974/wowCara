...
async function getCharacterInfo(token, region, realm, characterName, locale) {
  const baseUrl = `https://${region}.api.blizzard.com`;
  const apiUrl = `${baseUrl}/profile/wow/character/${realm}/${characterName}?namespace=profile-${region}&locale=${locale}`;
