...
async function ShowInfo(name, data, dataApp, rIO) {
    ...
    try {
      ...
      const mythicNerubar = Math.round(nerubarPalace.mythic_bosses_killed / nerubarPalace.total_bosses * 100);
      ...
      seasonDungeonId.forEach(([id, shortName]) => {
        ...
        const dungeonDifficulty = document.getElementById(`${shortName}-difficulty`);
      ...
      const baseClasses = ["flex", "relative", "font-bold", "justify-center", "font-mono"];
